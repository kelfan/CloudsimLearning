 ...
 * consist of several {@link MergeCloudlet MergeCloudlets}.
 * 
...
public class MergeAppCloudlet {
	...
	public int appID;
        ...
        /**
         * The list of {@link MergeCloudlet} that this AppCloudlet represents.
         */
	public ArrayList<MergeCloudlet> clist;
	...
	public MergeAppCloudlet(int type, int appID, double deadline, int numbervm, int userId) {
		super();
		this.type = type;
		this.appID = appID;
		...
		this.userId = userId;
		clist = new ArrayList<MergeCloudlet>();
	}
