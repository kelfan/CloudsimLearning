 ...
 */
public class MergeEdgeSwitch extends MergeSwitch {
	 ...
	 */
	public MergeEdgeSwitch(String name, int level, MergeDatacenter dc) {
		super(name, level, dc);
		hostlist = new HashMap<Integer, MergeHost>();
		uplinkswitchpktlist = new HashMap<Integer, List<MergeNetworkPacket>>();
		packetTohost = new HashMap<Integer, List<MergeNetworkPacket>>();
		uplinkbandwidth = MergeConstants.BandWidthEdgeAgg;
		downlinkbandwidth = MergeConstants.BandWidthEdgeHost;
		switching_delay = MergeConstants.SwitchingDelayEdge;
		numport = MergeConstants.EdgeSwitchPort;
