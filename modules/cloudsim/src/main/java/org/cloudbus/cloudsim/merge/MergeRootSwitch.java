 ...
 */
public class MergeRootSwitch extends MergeSwitch {
	 ...
	 */
	public MergeRootSwitch(String name, int level, MergeDatacenter dc) {
		super(name, level, dc);
		downlinkswitchpktlist = new HashMap<Integer, List<MergeNetworkPacket>>();
		downlinkswitches = new ArrayList<MergeSwitch>();

		downlinkbandwidth = MergeConstants.BandWidthAggRoot;
		latency = MergeConstants.SwitchingDelayRoot;
		numport = MergeConstants.RootSwitchPort;
	}
