 ...
 */
public class MergeCloudlet extends Cloudlet implements Comparable<Object> {
	...
	public ArrayList<MergeTaskStage> stages;
	...
	public MergeCloudlet(
		...
		currStagenum = -1;
		this.memory = memory;
		stages = new ArrayList<MergeTaskStage>();
	}
