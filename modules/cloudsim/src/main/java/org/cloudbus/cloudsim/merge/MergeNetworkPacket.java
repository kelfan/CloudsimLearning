 ...
 */
public class MergeNetworkPacket {
    /**
     ...
     * get from a {@link MergeHostPacket} instance at {@link NetworkHost#sendpackets()}.
    ...
    public MergeNetworkPacket(int id, MergeHostPacket pkt2, int vmid, int cloudletid) {
            pkt = pkt2;
            sendervmid = vmid;
