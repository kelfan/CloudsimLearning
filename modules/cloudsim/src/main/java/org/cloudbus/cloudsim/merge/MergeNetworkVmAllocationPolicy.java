 ...
 */
public class MergeNetworkVmAllocationPolicy extends VmAllocationPolicy {
	 ...
	 * @post $none
	 */
	public MergeNetworkVmAllocationPolicy(List<? extends Host> list) {
		super(list);
	...
	public boolean allocateHostForVm(Vm vm) {
		...
		if (!getVmTable().containsKey(vm.getUid())) { // if this vm was not created
			do {// we still trying until we find a host or until we try all of them
				...
				MergeHost host = this.<MergeHost> getHostList().get(idx);
         ...
         */
	protected double getMaxUtilizationAfterAllocation(MergeHost host, Vm vm) {
		List<Double> allocatedMipsForVm = null;
		MergeHost allocatedHost = (MergeHost) vm.getHost();
